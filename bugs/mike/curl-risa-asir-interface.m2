...
restart
loadPackage("RisaAsir", FileName => "~/src/M2/M2/Macaulay2/packages/RisaAsir.m2")
load "curl.m2"
W = QQ[s,x,y,dx,dy,WeylAlgebra=>{x=>dx,y=>dy}]
I = ideal(x*dx+y*dy-3,x*dx-y*dy)
bFunction(I, {1,1})
genericBfct({x*dx+y*dy-3,x*dx-y*dy},{x,y},{dx,dy},{1,1})
...
cmd = ///primadec([x^3-1],[x])///

getWWW("http://asir2.math.kobe-u.ac.jp/cgi-bin/cgi-generic_bfct.sh")
